...
export default function MenuPage() {
  ...
  return (
    <div className="page page-with-nav" style={{ paddingBottom: 90 }}>
      {/* Search */}
      <div style={{ padding: '16px 16px 12px', position: 'sticky', top: 'var(--nav-height)', zIndex: 50, background: 'rgba(10,10,15,0.85)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '1px solid var(--border)' }}>
      ...
      {/* Category pills */}
      <div className="container" style={{ padding: '14px 16px', overflowX: 'auto', display: 'flex', gap: 8, scrollbarWidth: 'none', flexShrink: 0 }}>
